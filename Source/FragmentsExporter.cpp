...
bool ExportFragmentsFile (const ModelerAPI::Model& model, const IO::Location& location)
{
    ...
    if (!WriteContentToFile (location, builder.GetBufferPointer (), builder.GetSize ())) {
        return false;
    }
